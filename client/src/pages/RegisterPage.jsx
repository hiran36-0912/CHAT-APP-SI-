...
import { MessageSquare, Lock, User, Mail, ArrowRight, UserCheck } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center items-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-400 mt-1">Get started with real-time conversations today</p>
        </div>
